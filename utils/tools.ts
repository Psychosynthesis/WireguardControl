...
export const normalizeLineBreaks = (data: string) => data.replace(/\r\n/g, '\n');

export const getNameFromSavedData = (key: string) => {
...
export const getStatusFromBash = async (): Promise<AppResult> => {
...
export const transCyrilic = (str: string) => {
  return str.replace(
    /[ЁёА-я]/g,
    c =>
      ({
